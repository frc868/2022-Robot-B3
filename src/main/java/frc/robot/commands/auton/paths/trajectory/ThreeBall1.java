...
public class ThreeBall1 extends SequentialCommandGroup {
    public ThreeBall1(Trajectory trajectory, Drivetrain drivetrain, Shooter shooter, Intake intake, Hopper hopper,
            Limelight limelight) {
        addCommands(
