...
public class ThreeBall1 extends SequentialCommandGroup implements AutoTrajectoryCommand {
    private ArrayList<AutoPath> autoPaths = new ArrayList<AutoPath>();

    public ThreeBall1(ArrayList<AutoPath> autoPaths, Drivetrain drivetrain, Shooter shooter, Intake intake,
